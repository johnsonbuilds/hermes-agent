...
#
# Fork note: the ClawCloud config seeding (.clawcloud.env.example /
# clawcloud-config.yaml.example) that the pre-s6 version of this script
# performed now lives in docker/stage2-hook.sh's seed_one() calls.
#

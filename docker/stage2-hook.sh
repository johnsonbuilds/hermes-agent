...
# upstream's .env.example / cli-config.yaml.example. Preserves the fork's
# ClawCloud-tuned first-boot defaults (see upstream-sync-instructions.md).
seed_one ".env" ".clawcloud.env.example"
seed_one "config.yaml" "clawcloud-config.yaml.example"
